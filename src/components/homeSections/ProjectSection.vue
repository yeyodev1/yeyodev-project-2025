...
// Loads any .png/.jpg/.webp placed in src/assets/projects/ — no build error if empty
const projectImages = import.meta.glob('@/assets/projects/*.(png|jpg|webp|PNG|JPG)', {
  eager: true,
  query: '?url',
  import: 'default',
  ...
  <section id="projects" class="projects">
    <div class="projects__container">
      ...
      <Transition name="fade-list" mode="out-in">
        <Timeline :key="activeFilter" :data="displayed" />
      </Transition>
